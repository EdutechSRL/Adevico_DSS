...
{
    public interface IViewEditMenubar : iDomainView
    {
       ...
       // void SelectTreeItem(dtoTreeItem selectedItem);
        ...
        void SaveError();
        void CreateError(MenuItemType type);
        void DeleteError(MenuItemType type);
        void ChangeTreeItemName(dtoItem selectedItem, String name, long position);
