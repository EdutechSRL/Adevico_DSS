...
{
    public class UC_ImportCommunityGlossaryPresenter : DomainPresenter
    {
        ...
        private void UpdateView(litePerson person, ModuleGlossaryNew module)
        {
            ...
            if (View.IdCommunity > 0)
            {
                ...
                View.LoadViewData(list);
            }
        }

        public void UpdateView(List<int> listIds)
        {
            var litePerson = CurrentManager.GetLitePerson(UserContext.CurrentUserID);
            if (UserContext.isAnonymous || litePerson == null)
            {
            ...
            var list = Service.GetCommunityGlossary(listIds);
            View.LoadViewData(list);
        }
        ...
        public void ImportGlossaries(List<long> listId)
        {
            var litePerson = CurrentManager.GetLitePerson(UserContext.CurrentUserID);
            if (UserContext.isAnonymous || litePerson == null)
            {
            ...
            Service.ImportGlossaries(View.IdCommunity, listId);
        }
        ...
        protected virtual IViewUC_ImportCommunityGlossary View
        {
            get { return (IViewUC_ImportCommunityGlossary) base.View; }
        }
        ...
        public UC_ImportCommunityGlossaryPresenter(iApplicationContext oContext)
            : base(oContext)
        {
