...
{
    public interface IViewGlossaryEdit : IViewPageBase
    {
        DTO_Glossary ItemData { get; set; }
        void SetTitle(String name);
        void LoadViewData(Int32 idCommunity, DTO_Glossary glossary, List<BaseLanguageItem> languages, List<NavigableWizardItem<Int32>> steps, Boolean fromListGlossary, Boolean showSaveNew);
