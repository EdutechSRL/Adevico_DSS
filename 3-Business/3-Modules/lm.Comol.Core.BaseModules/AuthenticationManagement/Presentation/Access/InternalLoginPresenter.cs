...
{
    public class InternalLoginPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        #region "Initialize"
            ...
            protected virtual IViewInternalLogin View
            {
                get { return (IViewInternalLogin)base.View; }
            }
            ...
            public InternalLoginPresenter(iApplicationContext oContext)
                : base(oContext)
            {
                this.CurrentManager = new BaseModuleManager(oContext);
            }
            public InternalLoginPresenter(iApplicationContext oContext, IViewInternalLogin view)
                : base(oContext, view)
            {
                this.CurrentManager = new BaseModuleManager(oContext);
            }
            ...
            if (urlProvider != null)
            {
                ...
                switch (vToken.Evaluation.Result)
                {
                    ...
                    default:
                        ...
                        View.DisplayInvalidToken(tokenUrl, idPerson, urlToken, vToken.Evaluation.Result);
                        //if (!String.IsNullOrEmpty(urlProvider.RemoteLoginUrl))
