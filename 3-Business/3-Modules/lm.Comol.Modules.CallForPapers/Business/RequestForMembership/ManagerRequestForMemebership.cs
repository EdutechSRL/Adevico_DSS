...
{
    public class ManagerRequestForMemebership : lm.Comol.Core.DomainModel.Common.iDomainManager

    {
        private iDataContext DC { set; get; }

        #region initClass
        public ManagerRequestForMemebership() { }

        public ManagerRequestForMemebership(iDataContext oDC)
        {
            this.DC = oDC;
        }

        public ManagerRequestForMemebership(iApplicationContext oContext)
        {
