...
{
    public class PublicRequestsListPresenter : lm.Comol.Core.DomainModel.Common.DomainPresenter
    {
        private const int currentPageSize = 25;
         #region "Initialize"
            ...
            protected virtual IViewPublicRequestsList View
            {
                get { return (IViewPublicRequestsList)base.View; }
            }
            ...
            public PublicRequestsListPresenter(iApplicationContext oContext)
                : base(oContext)
            {
                this.CurrentManager = new BaseModuleManager(oContext);
            }
            public PublicRequestsListPresenter(iApplicationContext oContext, IViewPublicRequestsList view)
                : base(oContext, view)
            {
                this.CurrentManager = new BaseModuleManager(oContext);
            }
