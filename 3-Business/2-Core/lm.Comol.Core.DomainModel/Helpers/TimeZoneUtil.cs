...
namespace lm.Comol.Core.DomainModel.Helpers
{
    public class TimeZoneUtil
    {
        ...
        ///// <returns></returns> 
        //public static DateTime AdjustDateToUserTimeZone(DateTime dt, Identity user)
        //{
        ...
        /// </summary> 
        /// <returns></returns> 
        public static SortedList<int,string> GetTimeZones()
        {
            SortedList<int, string> timeZones = new SortedList<int, string>(30);
