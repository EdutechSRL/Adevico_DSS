...
{
    [Serializable]
    public class ModuleCertifications
    {
        public const String UniqueCode ="SRVCRTF";
        public virtual Boolean ViewMyCertifications {get;set;}
        ...
        public ModuleCertifications() {
            //ViewTemplates = true;
        }
        public static ModuleCertifications CreatePortalmodule(int UserTypeID){
            ModuleCertifications module = new ModuleCertifications();
            module.ViewMyCertifications = (UserTypeID != (int)UserTypeStandard.Guest && UserTypeID != (int)UserTypeStandard.PublicUser);
