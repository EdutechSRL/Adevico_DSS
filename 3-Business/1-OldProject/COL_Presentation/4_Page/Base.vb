...
#End Region
    ...
    Protected Sub OverloadLanguage(ByVal LanguageCode As String)
        ...
        'Riportati per evitare di ricaricare l'oggetto lingue e tolto quello che non è necessario...

        OverloadLanguage(oLingua) 'Mi setta le seguenti opzioni (funzione già presente)
        'Session("LinguaID") = oLingua.ID
        'Session("LinguaCode") = oLingua.Codice
