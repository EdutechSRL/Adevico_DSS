...
Public Interface IviewEntrataComunita
	...
	Property FiltroAnnoAccademico() As FilterElement
	Property FiltroPeriodo() As FilterElement
	Property FiltroReferente() As FilterElement
	Property FiltroStatus() As FilterElement
	Property FiltroTipoCorsodiLurea() As FilterElement
	...
	Property Selezione_AnnoAccademico() As FilterElement
	Property Selezione_TipoComunita() As FilterElement
	Property Selezione_Periodo() As FilterElement
	Property Selezione_Referente() As FilterElement
	Property Selezione_Status() As FilterElement
	Property Selezione_TipoCorsodiLurea() As FilterElement

	' elementi filtri 
	WriteOnly Property ElencoOrganizzazioni() As List(Of COL_BusinessLogic_v2.IscrizioneComunita)
	WriteOnly Property ElencoPeriodi() As List(Of COL_Periodo)
	WriteOnly Property ElencoAnniAccademici() As List(Of AnnoAccademico)
	WriteOnly Property ElencoTipoCorsiDiLaurea() As List(Of COL_Tipo_CorsoDiStudi)
