Namespace UCServices
    Public Class Services_UserAccessReports
        Inherits UCServices.Abstract.MyServices

        Private Const Codice As String = "SRVUSAGER"
...
#Region "Public Property"
        Public Property ViewMyReport() As Boolean
            Get
                ViewMyReport = MyBase.GetPermissionValue(PermissionType.Read)
            End Get
            ...
            End Set
        End Property
        Public Property ViewOtherReports() As Boolean
            Get
                ViewOtherReports = MyBase.GetPermissionValue(PermissionType.Browse)
            End Get
            Set(ByVal Value As Boolean)
                If Value Then
            ...
            End Set
        End Property
        Public Property ViewPortalReports() As Boolean
            Get
                ViewPortalReports = MyBase.GetPermissionValue(PermissionType.Moderate)
            End Get
            Set(ByVal Value As Boolean)
                If Value Then
...
#End Region
        ...
        Public Shared Function Create() As Services_UserAccessReports
            Return New Services_UserAccessReports("00000000000000000000000000000000")
        End Function
        ...
        Public Enum ActionType
            ...
            NoPermission = 1
            GenericError = 2
            SpecifyFilters = 72003
            ViewReport = 72004
            ViewUsers = 72005
            ViewCommunities = 72006
            PrintReport = 72007
        End Enum
