...
#Region "Initialize"
    ...
    Protected Overridable ReadOnly Property View() As IViewUserStatistics
        Get
            Return DirectCast(MyBase.View, IViewUserStatistics)
        End Get
    End Property
    ...
    End Sub
    Public Sub New(oContext As iApplicationContext, view As IViewUserStatistics)
