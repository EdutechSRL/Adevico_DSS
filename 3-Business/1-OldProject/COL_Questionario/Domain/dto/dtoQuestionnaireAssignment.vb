...
<Serializable()>
Public Class dtoQuestionnaireAssignment
    Inherits DomainBaseObject(Of Long)
...
<Serializable()>
Public Class dtoQuestionnaireCommunityAssignment
    Inherits dtoQuestionnaireAssignment
...
<Serializable()>
Public Class dtoQuestionnairePersonAssignment
    Inherits dtoQuestionnaireAssignment
...
<Serializable()>
Public Class dtoQuestionnairePersonTypeAssignment
    Inherits dtoQuestionnaireAssignment
