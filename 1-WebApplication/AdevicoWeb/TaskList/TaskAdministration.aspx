<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master"
    CodeBehind="TaskAdministration.aspx.vb" Inherits="Comunita_OnLine.TaskAdministration" %>
...
<asp:Content ID="TSKcontent1" runat="server" ContentPlaceHolderID="CPHservice">
    <div style="width: 900px; text-align: center; margin: 0,auto; padding-top: 5px; clear: both;"
        ...
        <div id="FilterZone">
            <div id="RadTabDiv">
                <telerik:RadTabStrip ID="TBStasklist" runat="server" SelectedIndex="3" Align="Justify"
            ...
            <div>
                <div id="DivSopra" style="float: left; width: 80%;">
                    <div id="DDLdiv" style="float: left">
                    ...
                    <div style="float: left; width: 100%; display: block; text-align: left; clear: both;
                        margin-top: 7px">
            ...
            <div id="DivSotto" >
                <div id="RBLactiveCompletedDiv" style="float: left; width: 100%; text-align: left;
                    margin-top: 1px">
                    <asp:Literal ID="LTorderby" runat="server">**Order:</asp:Literal>
                            ...
                            <HeaderTemplate>
                                <table border="1" align="center" width="900px" cellspacing="0">
                                    <tr class="ROW_header_Small_Center">
                                        ...
                                        <td align="center" width="110px" style="text-align: center">
                                            <b>
