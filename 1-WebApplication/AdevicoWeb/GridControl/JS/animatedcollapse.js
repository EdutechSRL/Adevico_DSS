...
animatedcollapse.prototype.slideit=function(){
	...
	if(document.getElementById("bottone2").className == "bottone bottone2"){
    document.getElementById("bottone2").className = document.getElementById("bottone2").className.replace("bottone2","bottoneH");
	}else{
	  document.getElementById("bottone2").className = document.getElementById("bottone2").className.replace("bottoneH","bottone2");
	}
