...
Partial Public Class WizardUrlTokenValidateProfile
    ...
    '''<summary>
    '''VIWunknownProfile control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents VIWunknownProfile As Global.System.Web.UI.WebControls.View

    '''<summary>
    '''CTRLunknownProfile control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CTRLunknownProfile As Global.Comunita_OnLine.UC_AuthenticationStepUnknownProfile

    '''<summary>
    '''VIWinternalCredentials control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents VIWinternalCredentials As Global.System.Web.UI.WebControls.View

    '''<summary>
    '''CTRLinternalCredentials control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents CTRLinternalCredentials As Global.Comunita_OnLine.UC_AuthenticationStepInternalCredentials
    ...
    '''<summary>
    '''VIWwaitingMessage control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents VIWwaitingMessage As Global.System.Web.UI.WebControls.View

    '''<summary>
    '''LTwaitingMessage control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents LTwaitingMessage As Global.System.Web.UI.WebControls.Literal
