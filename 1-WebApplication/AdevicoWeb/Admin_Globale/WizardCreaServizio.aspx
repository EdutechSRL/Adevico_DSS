<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin_Globale/AdminPortal.Master"
 Codebehind="WizardCreaServizio.aspx.vb" Inherits="Comunita_OnLine.WizardCreaServizio"%>
...
<%@ Register TagPrefix="CTRL" TagName="CTRLfinale" Src="./UC_WizardCreaServizio/UC_AdminServizioConfermaFinale.ascx" %>
					...
					<table cellSpacing=0 cellPadding=0 border=0 align=right>
						<tr>
							...
							<td width=100 nowrap="nowrap" >
								...
								<asp:Button id=BTNcrea2 runat="server" CssClass="PulsanteFiltro" Text="Crea"></asp:Button>
							</td>
							<td width=20>&nbsp;</td>
						</tr>
					</table>
					...
					<table cellSpacing=0 cellPadding=0 border=0 align=right>
						<tr>
							...
							<td width=100 nowrap="nowrap" >
								...
								<asp:Button id=BTNcrea runat="server" CssClass="PulsanteFiltro" Text="Crea"></asp:Button>
							</td>
							<td width=20>&nbsp;</td>
						</tr>
					</table>
