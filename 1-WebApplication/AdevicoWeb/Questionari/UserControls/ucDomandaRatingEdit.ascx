<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucDomandaRatingEdit.ascx.vb"
    Inherits="Comunita_OnLine.ucDomandaRatingEdit" %>
        ...
        <ItemTemplate>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList Enabled='<%#Not isDomandaReadOnly%>' ID="DDLNumeroColonne" runat="server"
                            AutoPostBack="true" OnSelectedIndexChanged="selezionaNumeroIntestazioni">
                    ...
                    <td>
                        <asp:RadioButtonList runat="server" ID="RBLTipoIntestazione" Enabled='<%#Not isDomandaReadOnly%>'
                            RepeatDirection="Vertical" AutoPostBack="true" OnSelectedIndexChanged="selezionaTipoIntestazione">
