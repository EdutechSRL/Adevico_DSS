...
Partial Public Class ucDomandaRatingStarsEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If init Then 'Not Page.IsPostBack Then
        caricaDati()
        bindFields()
        bindIntestazioni()
        bindOpzioni()
        ...
        oGestioneDomande.crea_Stars(FRVDomanda, isChangingTable)
        'End If
    ...
    Protected Sub bindFields()
        oGestioneDomande.bindFieldDomandaRatingStars(FRVDomanda, Me.DomandaCorrente, oPagina, Me.QuestionarioCorrente)
    End Sub
    Protected Sub bindOpzioni()
        oGestioneDomande.bindOpzioniDomandaRatingStars(FRVDomanda, Me.DomandaCorrente, oPagina, Me.QuestionarioCorrente)
    End Sub
    Protected Sub bindIntestazioni()
        oGestioneDomande.bindIntestazioniDomandaRatingStars(FRVDomanda, Me.DomandaCorrente, oPagina, Me.QuestionarioCorrente)
    End Sub
    Protected Sub selezionaNumeroOpzioni(ByVal sender As Object, ByVal e As System.EventArgs)

        isChangingTable = True

        Me.DomandaCorrente = oGestioneDomande.setDomandaRatingStars(FRVDomanda, Me.DomandaCorrente, Me.QuestionarioCorrente)
