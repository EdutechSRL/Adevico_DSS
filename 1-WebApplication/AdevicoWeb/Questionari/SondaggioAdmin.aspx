<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master"
    CodeBehind="SondaggioAdmin.aspx.vb" Inherits="Comunita_OnLine.SondaggioAdmin"
                            ...
                            <tr>
                                <td colspan="3" bordercolor="white">
                                    ...
                                    <CTRL:CTRLeditor id="CTRLeditorDescrizioneQuestionario" runat="server" ContainerCssClass="containerclass" 
                                        LoaderCssClass="loadercssclass" EditorHeight="300px" EditorWidth="100%" FontSizes="2" AllAvailableFontnames="true" AutoInitialize="true" ModuleCode="SRVQUST"
                                ...
                                <tr>
                                    <td bordercolor="white" style="padding: 7px;">
                                        ...
                                        <asp:Label ID="LBOrdineDomandeRandom" runat="server"></asp:Label>
                                         <asp:Label ID="LBanonymousResults_t" runat="server">Anonymous results:</asp:Label>
                                        <asp:CheckBox runat="server" ID="CBXanonymousResults" Checked='<%#Eval("risultatiAnonimi")%>'  /><asp:Label ID="LBanonymousResults" runat="server">Yes</asp:Label> <br /><br />
