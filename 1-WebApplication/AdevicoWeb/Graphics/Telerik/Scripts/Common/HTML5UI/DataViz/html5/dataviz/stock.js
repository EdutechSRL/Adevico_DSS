...
})(function(){(function(a,H){var q=window.kendo,f=q.Class,z=q.Observable,k=q.deepExtend,u=Math,A=a.proxy,I=q.util,r=I.last,B=I.renderTemplate,j=q.dataviz,l=I.defined,p=j.filterSeriesByType,E=q.template,e=j.ui.Chart,C=j.Selection,b=j.addDuration,s=I.limitValue,t=j.lteDateIndex,F=j.toDate,G=j.toTime;
...
O.redraw(P);
},_drag:function(Q){var T=this,N=T.chart,O=N._eventCoordinates(Q.originalEvent),U=T.mainAxis(),V=U.range(),S=U.pane.box.containsPoint(O),M=N._plotArea.categoryAxis,W=Q.axisRanges[M.options.name],X=T.options.select,Y=T.selection,P,R,Z;
if(!W||S||!Y){return;
...
var O=p(S,o);
var P=O.length===0;
var M=k({type:"date",pane:x,roundToBaseUnit:!P,justified:P,_collapse:false,tooltip:{visible:false},labels:{step:1},autoBind:!Q.dataSource,autoBaseUnitSteps:{minutes:[1],hours:[1,2],days:[1,2],weeks:[],months:[1],years:[1]},_overlap:false});
var T=Q.categoryAxis;
N.push(k({},M,{maxDateGroups:200},T,{name:w,baseUnit:"fit",baseUnitStep:"auto",labels:{visible:false},majorTicks:{visible:false}}),k({},M,T,{name:w+"_labels",maxDateGroups:20,baseUnitStep:"auto",autoBaseUnitSteps:{minutes:[]},majorTicks:{visible:true}}),k({},M,T,{name:w+"_ticks",maxDateGroups:200,majorTicks:{visible:true,width:0.5},labels:{visible:false,mirror:true}}));
