...
})(function(){(function(a,F){var q=window.kendo,z=q.support,f=window.document,c=q.Class,t=q.Observable,s=a.now,i=a.extend,u=z.mobileOS,p=u&&u.android,d=800,e=z.browser.msie?5:0,v="press",o="hold",x="select",y="start",r="move",h="end",b="cancel",A="tap",w="release",l="gesturestart",j="gesturechange",k="gestureend",m="gesturetap";
