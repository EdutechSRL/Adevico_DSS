...
}b.RadAsyncUpload.Statics={extendViewWith:function(d){a.extend(d,{_calculateSelectedFiles:function(e){if(e.find(".ruUploadSuccess, .ruUploadFailure, .ruUploadCancelled").size()>0){this._selectedFilesCount--;
