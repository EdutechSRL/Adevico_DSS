...
}b.RadAsyncUpload.Statics={extendViewWith:function(d){a.extend(d,{_calculateSelectedFiles:function(e){if(e.hasClass("ruUploadSuccess")||e.hasClass("ruUploadFailure")||e.hasClass("ruUploadCancelled")){this._selectedFilesCount--;
