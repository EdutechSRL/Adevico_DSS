...
#Region "Inherited"
    ...
    Public Overrides Sub SetInternazionalizzazione()
        With MyBase.Resource
            ...
            '.setLabel_To_Value(Me.LBtitolo, "LBtitolo.organization." & stringaTitolo.forSubscribe)
            Me.Master.ServiceTitle = .getValue("LBtitolo.organization." & stringaTitolo.forSubscribe)
...
#Region "Bind_Dati"
    ...
    Private Function FiltraggioDati(Optional ByVal ApplicaFiltri As Boolean = False) As DataSet
        ...
        Try
            ...
            End If
            oDataset = COL_Comunita.FindOrganizations(oFiltroIscrizione, Session("LinguaID"), oPersona.ID, ResponsabileID, valore, FiltroStatoComunita.Attiva)
    ...
    Private Function FiltraggioDatiRistretto() As DataSet
        ...
        Try
            ...
            If valore <> "" Then
                valore = Replace(valore, "'", "''")
            End If
            oDataset = COL_Comunita.FindOrganizations(FiltroRicercaComunitaByIscrizione.nonIscritto, Session("LinguaID"), oPersona.ID, ResponsabileID, valore, FiltroStatoComunita.Attiva)
