...
#Region "Gestione TreeView"
    Private Sub Bind_TreeView(Optional ByVal forConferma As Boolean = True, Optional ByVal checkID As Integer = -1)
        ...
        Try
            ...
            nodeRoot.Text = oResource.getValue("ElencoComunita") '"Elenco Comunità"

            nodeRoot.Expanded = True
            nodeRoot.ImageUrl = "folder.gif"
            nodeRoot.Value = ""
            nodeRoot.ToolTip = oResource.getValue("ElencoComunita") '"Elenco Comunità"
            nodeRoot.Category = 0
    ...
    Private Sub GeneraNoNode()
        ...
        oRootNode.Text = oResource.getValue("Comunita")  '"Comunità: "
        oRootNode.Value = ""
        oRootNode.Expanded = True
        oRootNode.ImageUrl = "folder.gif"
        oRootNode.ToolTip = oResource.getValue("iscritti") '"Elenco comunità a cui si è iscritti"
        oRootNode.Category = 0
        oRootNode.ContextMenuName = "Base"

        oNode = New RadTreeNode
        oNode.Expanded = True
        oNode.Text = oResource.getValue("noSottoCmnt")  '"Non vi è alcuna sotto-comunità"
        oNode.Value = ""
        oNode.ToolTip = oResource.getValue("noSottoCmnt")  '"Non vi è alcuna sotto-comunità"
        oNode.Category = 0
    ...
    Private Sub LNBelimina_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LNBelimina.Click
        ...
        Else
            ...
            Try
                ...
                'Me.LBdettagliElimina.Text = oResource.getValue("LBdettagliElimina1") ' "Elenco comunità cancellate (reali o semplici link):<br>"
