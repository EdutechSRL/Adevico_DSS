...
#Region "Dashboard"
    Public Sub AddActionNoPermission(ByVal CommunityID As Integer, ByVal PersonID As Integer) Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.AddActionNoPermission

    End Sub

    Public Sub AddShowMessageAction(ByVal NoticeBoardID As Long, ByVal CommunityID As Integer) Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.AddShowMessageAction

    End Sub

    Public ReadOnly Property CommunitiesNoticeBoardPermission() As System.Collections.Generic.IList(Of lm.Comol.Core.DomainModel.ModuleCommunityPermission(Of ModuleNoticeBoard)) Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.CommunitiesNoticeBoardPermission
        Get
    ...
    Public Property CurrentMessageID() As Long Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.CurrentMessageID
        Get
    ...
    Public ReadOnly Property PreloadedCommunityID() As Integer Implements IViewDashBoard.PreloadedCommunityID
        ...
        End Get
    End Property
    Public Function GetMessageNavigationUrl(ByVal MessageID As Long, ByVal oContext As NoticeBoardContext, ByVal oView As NoticeBoardContext.ViewModeType, ByVal oSmallView As NoticeBoardContext.SmallViewType) As String Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.GetMessageNavigationUrl

    End Function

    Public Sub NavigationUrl(ByVal oContext As NoticeBoardContext, ByVal oView As NoticeBoardContext.ViewModeType, ByVal oSmallView As NoticeBoardContext.SmallViewType) Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.NavigationUrl

    End Sub

    Public Sub NoPermissionToAccess() Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.NoPermissionToAccess

    End Sub

    Public Sub setHeaderTitle(ByVal CommunityName As String) Implements lm.Comol.Modules.Base.Presentation.IViewDashBoard.setHeaderTitle
