<%@ Control Language="vb" AutoEventWireup="false" Codebehind="UC_Fase3AggiungiComunitaPadri.ascx.vb" Inherits="Comunita_OnLine.UC_Fase3AggiungiComunitaPadri" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<input type=hidden id="HDN_ComunitaPadriElenco" runat=server NAME="HDN_ComunitaPadriElenco"/>
				...
				<asp:TableCell HorizontalAlign="Center" ColumnSpan="2" CssClass="Filtro_CellFiltri" width="100%">
					...
					<asp:Table ID="TBLfiltro" Runat="server" HorizontalAlign="Center" width="100%">
						...
						<asp:TableRow Runat="server" ID="TBRorgnCorsi">
							<asp:TableCell>
								<asp:Table ID="TBLcorsi" CellPadding="2" CellSpacing="2" BorderStyle="None" Runat="server" Visible="False" Width="100%">
									<asp:TableRow>
										<asp:TableCell>
