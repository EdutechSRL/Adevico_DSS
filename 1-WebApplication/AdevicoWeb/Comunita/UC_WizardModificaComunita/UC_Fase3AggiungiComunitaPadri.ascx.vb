...
Public Class UC_Fase3AggiungiComunitaPadri
...
#Region "Bind_Filtri"
    ...
    Private Function FiltraggioDati() As DataSet
        ...
        Try
            ...
            Dim oDatasetAssegnate As DataSet
            Try
                Dim oComunita As New COL_Comunita
                oComunita.Id = Me.HDN_ComunitaAttualeID.Value
                oDatasetAssegnate = oComunita.GetPadri(Session("LinguaID"))
            Catch ex As Exception
                oDatasetAssegnate = Nothing
            End Try
    
            oDataset = oTreeComunita.RicercaComunitaAlberoRidottoByServizio(Services_AmministraComunita.Codex, oPersona, Me.oResourceUCcomunita, ImageBaseDir, TipocomunitaID, FacoltaID, , , , oFiltroTipoRicerca, valore, StatusID, Me.HDN_Livello.Value, , oDatasetAssegnate)
