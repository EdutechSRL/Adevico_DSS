<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="DashBoard.aspx.vb" Inherits="Comunita_OnLine.DashBoard" Theme="Materiale" EnableTheming="true" %>
            ...
            <div style="float:left; width:430px;">
                <div style="margin-top:5px;">
                    ...
                    <div class="fakeFieldset">
                         ...
                         <span class="right"><asp:HyperLink ID="HYPmoreNews" runat="server" Text=" More " CssClass="Link_Menu" NavigateUrl="~/Notification/CommunitiesLastUpdates.aspx?PageSize=100&Page=0"></asp:HyperLink> <%--SkinID="Menu_ButtonLike"--%> </span>
                         <hr/> 
                    </div>
                    <div>
