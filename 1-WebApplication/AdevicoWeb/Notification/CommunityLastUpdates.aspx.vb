...
#Region "View"
    ...
    Public ReadOnly Property CurrentView() As lm.Modules.NotificationSystem.Domain.ViewModeType Implements IViewCommunityNews.CurrentView
        Get
            Return ViewModeType.CurrentCommunity
        End Get
    End Property
#End Region
#Region "Base Context"
...
#End Region
    ...
    Public Sub LoadTabs(ByVal oTabList As System.Collections.Generic.List(Of lm.Modules.NotificationSystem.Presentation.dtoTab)) Implements lm.Modules.NotificationSystem.Presentation.IViewCommunityNews.LoadTabs
        ...
        'Dim Quote As String = """"
        'If oTabList.Count > 0 Then
        '    Tabs = "<ul class=" & Quote & "navlist" & Quote & ">"
        '    For Each oTab As dtoTab In oTabList
        '        If oTab.Selected Then
        '            Tabs &= vbCrLf & "<li class=" & Quote & "current" & Quote & ">"
        '        Else
        ...
        '        End If
        '        If oTab.Url <> "" AndAlso oTab.Enabled Then
        '            Tabs &= "<a href=" & Quote & oTab.Url & Quote & ">" & Resource.getValue("DayModeType." & oTab.TypeTab.ToString) & "</a>"
        '        Else
        '            Tabs &= oTab.TypeTab.ToString
        '        End If
        '        Tabs &= "</li>"
        '    Next
        '    Tabs &= vbCrLf & "</ul>"
    ...
    Public Sub LoadNotifications(ByVal DayToShow As String, ByVal oList As System.Collections.Generic.List(Of lm.Modules.NotificationSystem.Presentation.dtoModuleNews)) Implements lm.Modules.NotificationSystem.Presentation.IViewCommunityNews.LoadNotifications
    ...
    Public Function GetUrlDetails(ByVal oContext As lm.Modules.NotificationSystem.Domain.CommunityNewsContext, Optional ByVal WithBaseUrl As Boolean = True) As Object Implements lm.Modules.NotificationSystem.Presentation.IViewCommunityNews.GetUrlDetails
    ...
    Private Sub RPTallNews_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTallNews.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem OrElse e.Item.ItemType = ListItemType.Item Then
            ...
            If Not IsNothing(oDto) AndAlso Not IsNothing(oLink) Then
                oLink.Visible = Not String.IsNullOrEmpty(oDto.DefaultUrl)
                oName.Visible = String.IsNullOrEmpty(oDto.DefaultUrl)
    ...
    Private Sub DDLservices_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DDLservices.SelectedIndexChanged
        Me.CurrentPresenter.UpdateAllNews(True)
    End Sub
    ...
    Public Sub AddAction(ByVal CommunityID As Integer, ByVal PersonID As Integer, ByVal oActionType As COL_BusinessLogic_v2.UCServices.Services_CommunityNews.ActionType, ByVal oDay As Date) Implements lm.Modules.NotificationSystem.Presentation.IViewCommunityNews.AddAction
