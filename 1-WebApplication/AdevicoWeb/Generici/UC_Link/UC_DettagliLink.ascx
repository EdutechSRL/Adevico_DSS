<%@ Control Language="vb" AutoEventWireup="false" Codebehind="UC_DettagliLink.ascx.vb" Inherits="Comunita_OnLine.UC_DettagliLink" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
