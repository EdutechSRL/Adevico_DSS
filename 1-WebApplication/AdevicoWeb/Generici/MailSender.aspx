<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" Codebehind="MailSender.aspx.vb" Inherits="Comunita_OnLine.MailSender"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="JavaScript" >
		<!--
    	function ChangeState(evt, layerRef, state) {
				...
				<tr>
					<td align="center">
						...
						<asp:Panel ID="PNLcontenuto" Runat="server" HorizontalAlign="Center" width="900px">
							<asp:Table id="TBLContenuto" Runat="server" BorderWidth="0" CellPadding="2" CellSpacing="0">
								<asp:TableRow ID="TBRvoid">
								...
								<asp:TableRow ID="TBRobj">
									...
									<asp:TableCell>
										...
										<asp:textbox id="TXBObj" runat="server" MaxLength="100" Columns="99" Width="597" CssClass="Testo_Mail"></asp:textbox>
									</asp:TableCell>
									<asp:TableCell>
										&nbsp;&nbsp;
										<asp:LinkButton ID="LNBMostraAttach" Runat="server" CssClass="Filtro_Link" CausesValidation="False">Mostra Allegati</asp:LinkButton>
									</asp:TableCell>
								</asp:TableRow>
								...
								<asp:TableRow ID="TBRbody" Runat="server">
									...
									<asp:TableCell ColumnSpan="2" Width="700">
										<asp:textbox id="TXBbody" runat="server" rows="15" textmode="multiline" Width="715" Columns="88" CssClass="Testo_Mail"></asp:textbox>
									</asp:TableCell>
								</asp:TableRow>
									...
									<asp:TableCell ColumnSpan="3" HorizontalAlign="Right">
										<table align="right" border="0" cellspacing="0">
											<tr>
												...
												<td width="30px">&nbsp;</td>
												<td>
													<input id="BTNinvia" class="Pulsante" type="button" value="Invia" name="invia" runat="server"
														width="80" onserverclick="SendMail"/>
												</td>
											</tr>
										</table>
									</asp:TableCell>
