<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_ListaUtenti.ascx.vb" Inherits="Comunita_OnLine.UC_ListaUtenti" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<%@ Register TagPrefix="CTRL" TagName="CTRLsorgenteComunita" Src="../../UC/UC_FiltroComunitaByServizio_NEW.ascx" %>
<asp:Panel ID="Ricerca" runat="server" BackColor="Lavender">
...
<table width="850" align="right">
    ...
    <tr>
        <td align="right">
            <asp:CheckBox ID="CBvisualizzaSelezionati" runat="server" AutoPostBack="true" Text="Visualizza utenti selezionati"
                class="testo_campoSmall" />
            <asp:Button ID="Btn_AggiornaDestinatari" runat="server" CssClass="PulsanteFiltro"
                Text="Aggiorna" CausesValidation="false" Visible="false"></asp:Button>
            <br />
            <asp:Button ID="BTN_AnnullaInt" runat="server" Text="Annulla" CssClass="PulsanteFiltro">
            </asp:Button>
            <asp:Button ID="BTN_ConfermaSel" runat="server" Text="Conferma" CssClass="PulsanteFiltro">
            </asp:Button>
        </td>
    </tr>
    </table>
    ...
    <br />
    <asp:Panel ID="PNL_Destinatari" runat="server" ScrollBars="Vertical" Width="100%"
        Height="100px" BorderColor="darkBlue" BorderWidth="1px" BackColor="white">
        <div style="display: block; width: 100%;" class="TestoCampoSmall">
