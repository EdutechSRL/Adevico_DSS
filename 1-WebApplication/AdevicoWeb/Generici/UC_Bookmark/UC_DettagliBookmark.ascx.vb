...
Public Class UC_DettagliBookmark
    Inherits System.Web.UI.UserControl
    Protected oResourceDettagli As ResourceManager
...
#Region "Bind"
    Public Sub Bind_dettagli(ByVal BookMark_ID As Integer)
        ...
        Try
            ...
            With oBookMark
                ...
                If .Errore = Errori_Db.None Then
                    ...
                    If Not Equals(oBookMark.CreatoIl, New Date) Then
                        Me.TBRcreatoil.Visible = True
                        Me.LBcreato.Text = FormatDateTime(oBookMark.CreatoIl, DateFormat.ShortDate) & " " & FormatDateTime(oBookMark.CreatoIl, DateFormat.ShortTime)
                    Else
                        Me.TBRcreatoil.Visible = False
                    End If
                    If Not Equals(oBookMark.ModificatoIl, New Date) Then
                        Me.TBRmodificatoil.Visible = True
                        Me.LBmodificato.Text = FormatDateTime(oBookMark.ModificatoIl, DateFormat.ShortDate) & " " & FormatDateTime(oBookMark.ModificatoIl, DateFormat.ShortTime)
                    Else
                    ...
                    If .isFromComunita Then
                        ...
                        NomeComunita = COL_Comunita.EstraiNomeBylingua(.CMNT_ID, Session("linguaID"))
                        ...
                        If NomeComunita <> "" Then
                            Me.LBtipoLink.Text = Me.LBtipoLink.Text & "( " & NomeComunita & ")"
                        End If
...
#Region "Localizzazione"
    Private Sub SetCulture(ByVal Code As String)
        ...
        oResourceDettagli.ResourcesName = "pg_UC_DettagliBookMark"
        oResourceDettagli.Folder_Level1 = "Generici"
        oResourceDettagli.Folder_Level2 = "UC_Bookmark"
