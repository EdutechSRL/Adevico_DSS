<%@ Control Language="vb" AutoEventWireup="false" Codebehind="UC_CreaBookmark.ascx.vb" Inherits="Comunita_OnLine.UC_CreaBookmark" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<input type=hidden id="BOKM_PadreID" runat=server NAME="BOKM_PadreID"/>
<input type=hidden id="BOKM_isCartella" runat=server NAME="BOKM_isCartella"/>
...
<table  bgcolor=#FFFBF7 style="BorderColor:#CCCCCC" border=1 cellspacing=0 cellpadding=0 >
	<tr>
		<td align=center >
