...
Partial Public Class OtherCommunityAccessRegister
    Inherits PageBase
...
#End Region
    ...
    Private Sub CTRLcommunityList_ShowBackUrl(url As String, fromView As viewType) Handles CTRLcommunityList.ShowBackUrl
