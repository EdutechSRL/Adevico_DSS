<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="FindPortalUserRegisterByDate.aspx.vb" Inherits="Comunita_OnLine.FindPortalUserRegisterByDate" Theme="Materiale" EnableTheming="true" %>
...
<div id="DVmenu" style="width: 900px; text-align: right; padding-top: 5px; margin: 0px auto;
  ...
  <div style="width: 900px; text-align:center; margin:0,auto; padding-top:5px; clear:both;" align="center">
	   <CTRL:AccessTab id="CTRLaccessTab" runat="server" CurrentView="BetweenDateUsersPortal"></CTRL:AccessTab>
    </div>
    <div>
