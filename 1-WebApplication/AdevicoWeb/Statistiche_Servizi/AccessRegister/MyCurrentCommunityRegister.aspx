<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="MyCurrentCommunityRegister.aspx.vb" Theme="Materiale" Inherits="Comunita_OnLine.MyCurrentCommunityRegister" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHservice" runat="server">
    ...
    <div style="width: 900px; text-align:center; margin:0,auto; padding-top:5px; clear:both;" align="center">
	   <CTRL:AccessTab id="CTRLaccessTab" runat="server" CurrentView="CurrentCommunityPresence"></CTRL:AccessTab>
    </div>
    <div>
