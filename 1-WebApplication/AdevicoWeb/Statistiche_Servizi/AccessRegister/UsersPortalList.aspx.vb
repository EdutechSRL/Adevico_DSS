    ...
    Public ReadOnly Property CurrentPresenter() As ContentPagePresenter
        Get
            If IsNothing(_Presenter) Then
                _Presenter = New ContentPagePresenter(Me.PageUtility.CurrentContext, Me)
            End If
            Return _Presenter
        End Get
    End Property
...
#End Region
    ...
    Private Sub CTRLaccessTab_ActivateSubView() Handles CTRLaccessTab.ActivateSubView
        Me.CTRLusersList.Visible = True
        Me.CTRLusersList.InitControl(Me.ResultsContext, Me.CurrentView)
    End Sub
    ...
    Private Sub CTRLusersList_ActivateNoPermission() Handles CTRLusersList.ActivateNoPermission
        Me.CTRLusersList.Visible = False
    End Sub
    ...
    Private Sub CTRLusersList_ShowBackUrl(url As String, fromView As viewType) Handles CTRLusersList.ShowBackUrl
