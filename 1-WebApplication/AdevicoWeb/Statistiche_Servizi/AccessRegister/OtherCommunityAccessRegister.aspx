<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="OtherCommunityAccessRegister.aspx.vb" Inherits="Comunita_OnLine.OtherCommunityAccessRegister" Theme="Materiale" EnableTheming="true" %>
<%@ Register TagPrefix="CTRL" TagName="CommunityList" Src="./UC/UC_CommunityAccessRegister.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHservice" runat="server">
    ...
    <div style="width: 900px; text-align:center; margin:0,auto; padding-top:5px; clear:both;" align="center">
	   <CTRL:AccessTab id="CTRLaccessTab" runat="server" CurrentView="OtherUserCommunityList"></CTRL:AccessTab>
    </div>
    <div>
        <CTRL:CommunityList id="CTRLcommunityList" runat="server" isPersonal="false"></CTRL:CommunityList>
    </div>
</asp:Content>