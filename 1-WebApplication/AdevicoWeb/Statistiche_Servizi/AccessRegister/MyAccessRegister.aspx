<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="MyAccessRegister.aspx.vb" Inherits="Comunita_OnLine.MyAccessRegister" Theme="Materiale" EnableTheming="true" %>
...
<div id="DVmenu" style="width: 900px; text-align: right; padding-top: 5px; margin: 0px auto;
    ...
    <div>
        <ctrl:UserAccessResult id="CTRLuserAccessResult" runat="server" 
            ShowUserNameSearch="false"></ctrl:UserAccessResult>
    </div>
</asp:Content>