...
Partial Public Class MyCommunityAccessRegister
    Inherits PageBase
...
#Region "Generic Page Property"
    ...
    Public Overrides ReadOnly Property VerifyAuthentication() As Boolean
        ...
        End Get
    End Property
    Public ReadOnly Property PreLoadedPageSize() As Integer
        Get
            Dim PageSize As Integer = Me.CTRLcommunityList.DefaultPageSize
            Try
                PageSize = Request.QueryString("PageSize")
            Catch ex As Exception
                PageSize = Me.CTRLcommunityList.DefaultPageSize
            End Try
            If PageSize <= 0 Then
                PageSize = Me.CTRLcommunityList.DefaultPageSize
            End If
...
#End Region
    ...
    Private Sub CTRLaccessTab_ActivateSubView() Handles CTRLaccessTab.ActivateSubView
        Me.CTRLcommunityList.Visible = True
        Me.CTRLcommunityList.InitControl(Me.ResultsContext, Me.CurrentView)
    End Sub
    ...
    Private Sub CTRLcommunityList_ActivateNoPermission() Handles CTRLcommunityList.ActivateNoPermission
        Me.CTRLcommunityList.Visible = False
    End Sub
    Private Sub Page_PreLoad(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreLoad
        PageUtility.CurrentModule = PageUtility.GetModule(Services_UserAccessReports.Codex)
    End Sub

    Private Sub CTRLuserAccessResult_ShowBackUrl(url As String, fromView As viewType) Handles CTRLcommunityList.ShowBackUrl
