<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="MyCommunityAccessRegister.aspx.vb" Inherits="Comunita_OnLine.MyCommunityAccessRegister" Theme="Materiale" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPHservice" runat="server">
  ...
  <div style="width: 900px; text-align:center; margin:0,auto; padding-top:5px; clear:both;" align="center">
	   <CTRL:AccessTab id="CTRLaccessTab" runat="server" CurrentView="MyCommunitiesPresence"></CTRL:AccessTab>
    </div>

    <div>
        <CTRL:CommunityList id="CTRLcommunityList" runat="server" isPersonal="true"></CTRL:CommunityList>
    </div>
</asp:Content>