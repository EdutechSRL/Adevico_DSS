<%@ Control Language="vb" AutoEventWireup="false" Codebehind="VisEmo.ascx.vb" Inherits="Comunita_OnLine.VisEmo" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
