...
<%@ Register TagPrefix="CTRL" TagName="Attachments" Src="~/Modules/EduPath/UC/UC_AddRepositoryAction.ascx" %>
...
<asp:MultiView ID="MLVaddSubActivity" runat="server" ActiveViewIndex="0">
    ...
    <asp:View ID="VIWselector" runat="server">
        <div class="Row">
            <div class="ContainerLeft"><asp:Button ID="BTNaddRepositoryActivity" Text="*Add File" runat="server" CssClass="LinkMenu" /></div>
            <div class="ContainerRight"><asp:Label ID="LBsubActRepository" runat="server" CssClass="Details_Campo" /></div>
        </div>
        <div class="Row">
            <div class="ContainerLeft"><asp:Button ID="BTNaddTextAction" Text="*Add test" runat="server" CssClass="LinkMenu"  /></div>
            <div class="ContainerRight"><asp:Label ID="LBsubActText" runat="server" CssClass="Details_Campo" /></div>
        </div>
        <div class="Row" id="DVquestionnaire" runat="server">
            <div class="ContainerLeft"><asp:Button ID="BTNaddQuestionario" Text="*Add test" runat="server" CssClass="LinkMenu" /></div>
            <div class="ContainerRight"><asp:Label ID="LBsubActQuiz" runat="server" CssClass="Details_Campo" /></div>
        </div>
    ...
    <asp:View ID="VIWrepository" runat="server">
        ...
        <CTRL:ModuleToRepository ID="CTRLmoduleToRepository" runat="server" AjaxViewUpdate="true" MaxFileInput="5" Visible="false" />
    </asp:View>
    ...
    <asp:View ID="VIWcertifications" runat="server">
        <div class="Row"><CTRL:EditCertificationAction runat="server" ID="CTRLcertificationAction" IsInAjaxPanel="True" /></div>
    </asp:View>
