Public Class LoadCertificationModal
...
#End Region
    ...
    Private Sub LoadCertificationModal_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
        Master.ShowDocType = True
        Master.EnabledFullWidth = True
    End Sub
End Class