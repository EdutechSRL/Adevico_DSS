...
Public Class EduPathSelect
    ...
    Public Overrides Sub SetInternazionalizzazione()
        With Me.Resource
            ...
            HYPtimeAuto.NavigateUrl = BaseUrl & RootObject.AddPath(CurrentCommunityID, EPType.TimeAuto)
            .setHyperLink(HYPtimeManual, False, True)
            HYPtimeManual.NavigateUrl = BaseUrl & RootObject.AddPath(CurrentCommunityID, EPType.TimeManual)
            .setHyperLink(HYPvoteAuto, False, True)
            HYPvoteAuto.NavigateUrl = BaseUrl & RootObject.AddPath(CurrentCommunityID, EPType.MarkAuto)
            .setHyperLink(HYPvoteManual, False, True)
            HYPvoteManual.NavigateUrl = BaseUrl & RootObject.AddPath(CurrentCommunityID, EPType.MarkManual)
            .setLabel(LBtimeAuto)
