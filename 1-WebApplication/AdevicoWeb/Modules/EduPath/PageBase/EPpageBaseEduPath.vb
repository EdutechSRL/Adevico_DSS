...
Public MustInherit Class EPpageBaseEduPath
#Region "PageBase"
    Inherits Base
...
#End Region
    ...
    '    End If
    'End Sub
    Protected Friend Function GetIsMooc(ByVal idPath As Long) As Boolean
        ...
        If Not _IsMoocPath.HasValue Then
            If (idPath > 0) Then
                ...
                'End If
            Else
                _IsMoocPath = PreloadIsMooc
            End If
            IsMoocPath = _IsMoocPath.Value
            result = _IsMoocPath.Value
        Else
            result = _IsMoocPath.Value
        End If
        Return result
