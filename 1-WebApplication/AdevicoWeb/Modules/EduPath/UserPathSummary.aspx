...
<asp:Label runat="server" ID="LBservice">**Path Summary</asp:Label> - <asp:Label runat="server" ID="LBserviceUserName"></asp:Label>
</asp:Content>
            ...
            <asp:Repeater runat="server" ID="RPTusers">
                <HeaderTemplate>
                   <table class="treetable table light">
                    <thead>
                        <tr>
                            <th class="name"><asp:Label runat="server" ID="LBpathheader">**Path name</asp:Label></th>
