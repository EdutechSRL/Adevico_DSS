<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="View.aspx.vb" Inherits="Comunita_OnLine.ViewGlossary" %>
...
<div class="termscontainer container_12 clearfix">
    ...
    <div class="viewnaw grid_4">
        ...
        <span class="viewnav icons">
                        <asp:HyperLink ID="HYPviewMapList" runat="server" class="icon stack">
                             <span title="<%=GetViewAsStackedListText()%>" ></span>
                        </asp:HyperLink>
                        <%--
                        --%>
                        <span title="<%=GetViewAsListText()%>" class="icon list active"></span>
                    </span>
    ...
    <div class="maincontent grid_12">
                    ...
                    <div class="page <%# Container.DataItem.CssClass%>">
                        <div class="title">
                            ...
                            <asp:Panel CssClass="fieldrow more top" ID="PNLLetterTop" Visible="false" runat="server">
                                <asp:HyperLink runat="server" ID="HPYPreviuosPage">
                        ...
                        <asp:Repeater runat="server" ID="RPTterm" OnItemCommand="RPTterm_ItemCommand">
                            ...
                            <ItemTemplate>
                                <dt id="term-<%# Container.DataItem.Id%>" class="term <%# Container.DataItem.CssClass%> <%# GetTileClass(Container.DataItem.Id)%> collapsed">
                                ...
                                <dd id="definition-<%# Container.DataItem.Id%>" class="definition <%# Container.DataItem.CssClass%> collapsed">
                            ...
                            <FooterTemplate>
                                ...
                                <asp:Panel CssClass="fieldrow more bottom" ID="PNLLetterBottom" Visible="True" runat="server">
                                    <asp:HyperLink runat="server" ID="HPYNextPage">
        ...
        <div class="pager">
            <CTRL:GridPager ID="PGgrid" runat="server" ShowNavigationButton="False" EnableQueryString="true" Visible="false"></CTRL:GridPager>
        </div>
    </div>
