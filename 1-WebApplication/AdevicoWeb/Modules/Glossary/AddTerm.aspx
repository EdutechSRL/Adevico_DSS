<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="AddTerm.aspx.vb" Inherits="Comunita_OnLine.AddTerm" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPHservice" runat="server">
    ...
    <asp:Panel runat="server" CssClass="glossarywrapper edit" ID="PNLmain">
                ...
                <div class="maincontent grid_12">
                    <div class="fieldobject termedit">
                        ...
                        <div class="fieldrow term">
                            <asp:Label ID="LBtermName_t" runat="server" CssClass="fieldlabel" AssociatedControlID="TXBname">*Term</asp:Label>
                        ...
                        <div class="fieldrow status">
                            <asp:Label ID="LBtermStatus_t" runat="server" CssClass="fieldlabel" AssociatedControlID="SWHpublishAdd">*Status</asp:Label>
                            <CTRL:Switch ID="SWHpublishAdd" runat="server" Status="true"/>
                        </div>
