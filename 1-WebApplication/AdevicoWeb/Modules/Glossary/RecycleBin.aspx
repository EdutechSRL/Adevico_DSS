<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="RecycleBin.aspx.vb" Inherits="Comunita_OnLine.RecycleGlossary" %>
                ...
                <asp:Repeater runat="server" ID="RPTlist">
                    <HeaderTemplate>
                        ...
                        <tr>
                            ...
                            <th class="stats">
                                <asp:Literal ID="LTstats_t" runat="server"></asp:Literal>
                            </th>
                            <th class="type">
                                <asp:Literal ID="LTtype_t" runat="server"></asp:Literal>
                            </th>
                            <th class="actions">
                                <span class="icons">
                    ...
                    <ItemTemplate>
                        <tr class="glossary internal">
                            ...
                            <td class="stats">
                                <asp:Literal ID="LTstats" runat="server"></asp:Literal>
                            </td>
                            <td class="type">
                            ...
                            <td class="actions">
                                <span class="icons">
                                    <asp:LinkButton runat="server" ID="LNBglossaryRecover" CssClass="icon recover"></asp:LinkButton>
                    ...
                    <FooterTemplate>
                        <tr id="TRempty" runat="server" visible="false">
                            <td colspan="6">
                                <asp:Label ID="LBemptyItems" runat="server" CssClass="empty">*No glossaries</asp:Label>
                            </td>
                        </tr>
                        </tbody>
                        </table>
