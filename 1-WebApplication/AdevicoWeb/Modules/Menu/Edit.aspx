<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master"
    CodeBehind="Edit.aspx.vb" Inherits="Comunita_OnLine.EditMenubar" %>
        ...
        <asp:UpdatePanel ID="UDPdata" runat="server" RenderMode="Inline" ChildrenAsTriggers="true" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="RadTreeViewContainer">
                    <CTRL:MenubarTree ID="CTRLmenubarTree" runat="Server"></CTRL:MenubarTree>
                </div>
                        ...
                        <asp:View ID="VIWassignments" runat="server">
                           ...
                           <div style="clear: both;">
                                <div style="float: left; text-align: right;">
                                      <COL:DialogLinkButton runat="server" ID="DLBdelete" CausesValidation="false"
                              CssClass="Link_Menu"></COL:DialogLinkButton>
                             <COL:DialogLinkButton runat="server" ID="DLBvirtualDelete" CausesValidation="false"
                                            CommandName="ItemColumn" CssClass="Link_Menu" Visible="false"></COL:DialogLinkButton>
                                    <asp:Button ID="BTNsaveBottom" runat="server" Text="Save" ToolTip="Save" CssClass="Link_Menu" />
                                </div>
                            </div>
                        </asp:View>
                    </asp:MultiView>
         ...
         <COL:Dialog runat="server" ID="DLGphisicalDeleteItem" DialogClass="dialog_delete"
        ServerSideCancel="false"></COL:Dialog>
         <COL:Dialog runat="server" ID="DLGvirtualDeleteItem" DialogClass="dialog_virtualDelete"
        ServerSideCancel="false"></COL:Dialog>
    </div>
</asp:Content>
