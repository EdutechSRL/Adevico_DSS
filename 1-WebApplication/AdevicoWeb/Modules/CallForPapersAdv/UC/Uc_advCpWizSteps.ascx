<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Uc_advCpWizSteps.ascx.vb" Inherits="Comunita_OnLine.Uc_advCpWizSteps" %>
	...
	<ItemTemplate>
		...
		<li id="liItem" runat="server">
			...
			<div class="navigationstep" runat="server" id="DVnavigationStep">
				<div class="title">
					<asp:Label ID="LBitem" runat="server" Visible="false"></asp:Label>
					<asp:HyperLink ID="HTPlink" runat="server" Visible="false"></asp:HyperLink>
				...
				<div class="stepinfo clearfix">
					...
					<asp:Label ID="LBmessage" runat="server" CssClass="statustext" ></asp:Label>
