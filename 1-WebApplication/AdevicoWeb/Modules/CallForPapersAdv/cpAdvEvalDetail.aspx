<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPopup.Master" CodeBehind="cpAdvEvalDetail.aspx.vb" Inherits="Comunita_OnLine.cpAdvEvalDetail" %>
...
position: relative;*/
	   ...
	   span.booleanRating.passed
	   {
		   background-color: #99c74a;

	   }

	   span.booleanRating.failed
	   {
			...
			<div class="view">
				<div class="infobar">
					...
					<div class="fieldobject">
						...
						<div class="fieldrow">
							<asp:Label ID="LBcommitteesList_t" runat="server" CssClass="fieldlabel" AssociatedControlID="LBcommittee">Commissione:</asp:Label>
							<asp:Label ID="LBcommittee" runat="server" CssClass="fieldtext">*View committee:</asp:Label>
							<%--<asp:DropDownList ID="DDLcommittees" runat="server" CssClass="commissionsselect" AutoPostBack="true"></asp:DropDownList>--%>
						</div> 
					</div>  
					<div class="fieldrow buttons clearfix hide">
						...
						<thead>
							...
							<tr>
								...
								<asp:Repeater ID="RPTevaluators" runat="server" 
									OnItemDataBound="RPTevaluators_ItemDataBound"
									OnItemCommand="RPTevaluators_ItemCommand"
									DataSource="<%#Container.DataItem.Evaluators %>">
									<ItemTemplate>
										<th class="evaluator icons child-of-commission-<%#Container.DataItem.IdCommittee %>" id="THevaluator" runat="server">
											<asp:label ID="LBevaluatorName" runat="server" CssClass="evaluatorName"></asp:label>
											<br />
											<asp:Literal ID="LTEvalStatus" runat="server">
												<span class="evalstatus {0}">{1}</span>
											</asp:Literal>
											<br />
											<asp:LinkButton ID="LkbConfirm" runat="server" CssClass="icon accept" ToolTip="Conferma">C</asp:LinkButton>
											<asp:LinkButton ID="LkbSetDraft" runat="server" CssClass="icon refuse" ToolTip="Rimetti in bozza">D</asp:LinkButton>                                            
										</th>    
									</ItemTemplate>
								</asp:Repeater>
									...
									<ItemTemplate>
										<td class="evaluator" id="TDevaluator" runat="server">
											...
											<span class="vote " id="SPNvoteContainer" runat="server">
												<asp:Literal ID="LTpassed" runat="server"><span class="booleanRating {0}" title="{1}"></span></asp:Literal>
												<asp:Label ID="LBvote" runat="server" cssclass="number"></asp:Label>
												<asp:HyperLink ID="HYPvote" runat="server" CssClass="number" Visible="false" Target="_blank" Enabled="false"><span class="text" runat="server" visible="false" id="SPNfuzzy"><CTRL:CTRLfuzzyNumber id="CTRLfuzzyNumber" runat="server"></CTRL:CTRLfuzzyNumber></span></asp:HyperLink>
												<span class="icons">
