<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="EditProfileType.aspx.vb" Inherits="Comunita_OnLine.EditProfileType" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPHservice" runat="server">
     <div id="DVmenu" style="width: 900px; text-align: right; padding-top: 5px; margin: 0px auto;"
        ...
        <asp:LinkButton ID="LNBsaveTypeTop" runat="server" CssClass="Link_Menu"> </asp:LinkButton>
    </div>
       <div style="width: 900px; text-align: center; padding-top: 5px; margin: 0px auto;">
        <asp:MultiView ID="MLVprofiles" runat="server" ActiveViewIndex="1">
            ...
            <asp:View ID="VIWedit" runat="server">
                <span class="Fieldrow">
                    <asp:Label ID="LBcurrentUserType_t" runat="server" CssClass="Titolo_campo" AssociatedControlID="LBcurrentUserType">Current profile:</asp:Label>
                    <asp:Label ID="LBcurrentUserType" runat="server" CssClass="Testo_Campo"></asp:Label>
                </span>
                <span class="Fieldrow">
                    <asp:Label ID="LBnewUserType_t" runat="server" CssClass="Titolo_campo" AssociatedControlID="DDLnewUserType">New profile type:</asp:Label>
                    <asp:DropDownList ID="DDLnewUserType" runat="server" CssClass="Testo_Campo" AutoPostBack="true"></asp:DropDownList>    
                </span>
                <br />
     ...
     <div style="width: 900px; text-align: right; padding-top: 5px; margin: 0px auto;">
        <asp:LinkButton ID="LNBsaveTypeBottom" runat="server" CssClass="Link_Menu"> </asp:LinkButton>
    </div>
</asp:Content>