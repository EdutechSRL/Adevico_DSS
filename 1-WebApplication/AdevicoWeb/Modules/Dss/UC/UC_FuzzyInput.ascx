<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_FuzzyInput.ascx.vb" Inherits="Comunita_OnLine.UC_FuzzyInput" %>
...
<div class="fieldobject fuzzyoptions<%=CssClass%>">
    <div class="fieldrow fuzzyoption weight">
