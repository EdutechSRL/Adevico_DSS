...
Public Class UC_FuzzyInputIntermediateValues
...
#Region "Inherits"
    Protected Overrides Sub SetInternazionalizzazione()
        With Resource
            LTfuzzyInputDescription.Text = .getValue("Description.RatingType." & RatingType.intermediateValues.ToString)
            DVdescription.Visible = Not String.IsNullOrWhiteSpace(LTfuzzyInputDescription.Text)
            .setLabel(LBfuzzyInputTitleBetween)
            LBfuzzyInputTitle.Text = .getValue("LBfuzzyInputTitle.RatingType." & RatingType.intermediateValues.ToString)
        End With
    End Sub
#End Region
...
#Region "Internal"
    ...
    Public Function GetValueToString() As String
        ...
        If IdSelectedTo > 0 Then
            result &= " / " & SLratingValuesTo.Items(SLratingValuesTo.SelectedIndex).Text
