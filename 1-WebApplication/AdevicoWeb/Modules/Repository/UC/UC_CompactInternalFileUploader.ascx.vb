...
Public Class UC_CompactInternalFileUploader
...
#End Region
    ...
    Public Sub InitializeControl(ByVal idCommunity As Integer, anonymousUpload As Boolean) Implements IviewModuleSingleFileUploader.InitializeControl
