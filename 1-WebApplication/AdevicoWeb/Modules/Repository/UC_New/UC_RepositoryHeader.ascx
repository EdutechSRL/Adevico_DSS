<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_RepositoryHeader.ascx.vb" Inherits="Comunita_OnLine.UC_RepositoryHeader" %>
...
<script type="text/javascript" src="<%=GetBaseUrl() %>Jscript/Modules/Common/jquery.collapsableTreeAdv.js"></script>
...
<script type="text/javascript" src="<%=GetBaseUrl() %>Jscript/Modules/Common/jquery.ddlist.js"></script>
...
<script type="text/javascript" src="<%=GetBaseUrl() %>Jscript/Modules/Common/jquery.dotdotdot.min.js"></script>
