<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="Details.aspx.vb" Inherits="Comunita_OnLine.RepositoryItemDetails" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPHservice" runat="server">
    <div class="DivEpButton" id="DVmenu" runat="server"  Visible="true">
        ...
        <asp:HyperLink ID="HYPgotoEditDetailsPage" runat="server" CssClass="linkMenu" Visible="false">*View Details</asp:HyperLink>
    </div>
