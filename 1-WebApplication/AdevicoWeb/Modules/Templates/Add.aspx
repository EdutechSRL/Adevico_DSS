<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="Add.aspx.vb" Inherits="Comunita_OnLine.AddTemplate" %>
                    ...
                    <div class="rightcontent">
                        <div class="header">
                            <div class="DivEpButton">
                                ...
                                <asp:button ID="BTNcreateSettingsTop" runat="server" Text="Save" Visible="false"/>
                            </div>
                            ...
                            <div class="content">
                                <div class="fieldobject pagedescription">
                                    <div class="fieldrow fielddescription">
                                        <asp:Label ID="LBaddTemplateDescription" runat="server" CssClass="description"></asp:Label>
                                    </div>
                                </div>
                                ...
                                <div class="fieldobject selectorwrapper serviceselector" ID="DVmoduleSelector" runat="server" visible="false">
                                    <div class="fieldrow">
                                        <div class="choseselect clearfix">
                                            ...
                                            <div class="right">
                                                <!--<a href="" class="Link_Menu">Apply</a>-->
                                            </div>
                                            <div class="right">
                                                <span class="icons">
                                ...
                                <asp:Repeater ID="RPTnotificationSettings" runat="server" Visible="false">
                                    <HeaderTemplate>
                                        ...
                                        <li class="templatemedium sectioncontent <%#Container.DataItem.Channel.ToString() %>channel">
                                            <div class="templatemediumcontent">
                                                <div class="title clearfix">
                                                    ...
                                                    <div class="right">
                                                        <span class="icons">
                                                            <asp:Button ID="BTNdeleteSettings" runat="server" Text="D" CssClass="img_btn icon delete" CommandArgument="<%#Container.DataItem.Settings.Id %>" CommandName="virtualdelete"/>
                                                        </span>
                                                    </div>
                                ...
                                <div class="fieldrow no-data-message" id="DVnoNotifications" runat="server" visible="true">
                        ...
                        <div class="footer">
                            <div class="DivEpButton">
                                ...
                                <asp:button ID="BTNcreateSettingsBottom" runat="server" Text="Save" Visible="false"/>
                            </div>
                        </div>
                    </div>
                </div>
