<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_TaskListTree.ascx.vb" Inherits="Comunita_OnLine.UC_TaskListTree" %>
...
<div class="tablewrapper">
    <table class="table tasks <%=GetTableCssClass() %>  treetable light fullwidth">
        <thead>
            <tr>
                <th class="name">
                    <asp:Literal ID="LTtaskName_t" runat="server">*Activity Name</asp:Literal>
                </th>
                <th class="project" id="THprojectName" runat="server">
            ...
            <asp:Repeater ID="RPTcontainer" runat="server">
                <ItemTemplate>
                    <tr class="<%#Container.DataItem.CssClass%>" id="<%#Container.DataItem.IdRow %>">
                        <td class="name" id="TDgroupName" runat="server">
                        ...
                        <td class="project" id="TDprojectName" runat="server" visible="false">
                            <span class="text">
                    ...
                    <asp:Repeater ID="RPTtasks" runat="server" DataSource="<%#Container.DataItem.Tasks%>" OnItemDataBound="RPTtasks_ItemDataBound" OnItemCommand="RPTtasks_ItemCommand">
                        ...
                        <tr class="task child-of-<%#Container.DataItem.IdFatherRow %>" id="task-<%#Container.DataItem.Id %>">
                             <td class="name">
                                ...
                                <CTRL:dialog id="CTRLcompletionDialog" runat="server" onUpdateProjectInfo="UpdateProjectInfo"></CTRL:dialog>
                            </td>
                            <td class="project" id="TDprojectName" runat="server">
                                <span class="text">
                                    <a name="<%# Container.DataItem.Id.ToString() %>"></a><asp:HyperLink ID="HYPprojectName" runat="server"></asp:HyperLink>
                                </span>
                                <asp:Label ID="LBcommunityName" runat="server" CssClass="extrainfo"></asp:Label>
