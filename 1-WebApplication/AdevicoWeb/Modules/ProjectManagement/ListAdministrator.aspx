<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="ListAdministrator.aspx.vb" Inherits="Comunita_OnLine.ListAdministrator" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <CTRL:Header id="CTRLheader" runat="server" LoadProgressBarHeader="false" LoadTaskHeader="false"></CTRL:Header>
