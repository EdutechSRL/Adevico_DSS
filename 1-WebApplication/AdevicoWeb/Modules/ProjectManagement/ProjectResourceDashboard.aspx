<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="ProjectResourceDashboard.aspx.vb" Inherits="Comunita_OnLine.ProjectResourceDashboard" %>
 ...
 <asp:MultiView ID="MLVprojectList" runat="server" ActiveViewIndex="1">
        ...
        <asp:View ID="VIWcontent" runat="server">
            <div class="DivEpButton DivEpButtonTop">
                <asp:Button ID="BTNsaveMyCompletenessTop" runat="server" Text="*Save" CssClass="linkMenu savesubmit" CausesValidation="true"  Visible="false"/>
                <asp:HyperLink ID="HYPdashboardResourceTop" class="linkMenu" runat="server" Text="*Dashboard resource" Visible="false"></asp:HyperLink>
                <asp:HyperLink ID="HYPdashboardManagerTop" class="linkMenu" runat="server" Text="*Dashboard manager" Visible="false"></asp:HyperLink>
            ...
            <div class="DivEpButton DivEpButtonBottom" runat="server" visible="false" id="DVcommandsBottom">
                <asp:Button ID="BTNsaveMyCompletenessBottom" runat="server" Text="*Save" CssClass="linkMenu savesubmit" CausesValidation="true" Visible="false" />
                <asp:HyperLink ID="HYPdashboardResourceBottom" class="linkMenu" runat="server" Text="*Dashboard resource" Visible="false"></asp:HyperLink>
                <asp:HyperLink ID="HYPdashboardManagerBottom" class="linkMenu" runat="server" Text="*Dashboard manager" Visible="false"></asp:HyperLink>
