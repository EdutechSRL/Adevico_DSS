<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="ResourceDashboard.aspx.vb" Inherits="Comunita_OnLine.ResourceDashboard" %>
  ...
  <asp:MultiView ID="MLVprojectList" runat="server" ActiveViewIndex="1">
        ...
        <asp:View ID="VIWcontent" runat="server">
            <div class="DivEpButton DivEpButtonTop">
                <asp:Button ID="BTNsaveMyCompletenessTop" runat="server" Text="*Save" CssClass="linkMenu savesubmit" CausesValidation="true" />
            ...
            <div class="DivEpButton DivEpButtonBottom" runat="server" visible="false" id="DVcommandsBottom">
                <asp:Button ID="BTNsaveMyCompletenessBottom" runat="server" Text="*Save" CssClass="linkMenu savesubmit" CausesValidation="true" />
