...
Public MustInherit Class PMpageDashboard
    Inherits PMpageBaseDashboard

#Region "Context"
    Private _Presenter As DashboardPresenter
    Protected Friend ReadOnly Property CurrentPresenter() As DashboardPresenter
        Get
            If IsNothing(_Presenter) Then
                _Presenter = New DashboardPresenter(Me.PageUtility.CurrentContext, Me)
            End If
            Return _Presenter
        End Get
    End Property
