...
Partial Public Class MyCommunityStatistics
    Inherits MSpageBase
    Implements IViewMyCommunityStatistics


#Region "Private Property"
    Private _PageUtility As OLDpageUtility
    Private _Presenter As MyCommunityStatisticsPresenter
...
#Region "Base Context"
    Public Overloads ReadOnly Property BaseUrl() As String
        ...
        End Get
    End Property
    Public ReadOnly Property CurrentPresenter() As MyCommunityStatisticsPresenter
        Get
            If IsNothing(_Presenter) Then
                _Presenter = New MyCommunityStatisticsPresenter(PageUtility.CurrentContext, Me)
            End If
            Return _Presenter
        End Get
    End Property
...
#Region "View property"
    Private ReadOnly Property CurrentPageSize() As Integer Implements IViewMyCommunityStatistics.CurrentPageSize
        Get
            Return 30
        End Get
    End Property
    Private ReadOnly Property PreloadedFromView() As StatisticView Implements IViewMyCommunityStatistics.PreloadedFromView
        Get
        ...
        End Get
    End Property
    Private Property Pager() As lm.Comol.Core.DomainModel.PagerBase Implements IViewMyCommunityStatistics.Pager
        Get
        ...
        End Set
    End Property
    Private ReadOnly Property CurrentView() As StatisticView Implements IViewMyCommunityStatistics.CurrentView
        Get
            Return StatisticView.MyCommunity
        End Get
    End Property

    Private ReadOnly Property CurrentOrder() As StatisticOrder Implements IViewMyCommunityStatistics.CurrentOrder
        Get
    ...
    Private Property StatisticContext() As UsageContext Implements IViewMyCommunityStatistics.StatisticContext
        Get
...
#Region "Generici pagina"
    ...
    End Sub
#End Region
    Public Sub SetBackUrl(url As String) Implements IViewMyCommunityStatistics.SetBackUrl
    ...
    End Sub
    Public Sub DisplaySessionTimeout() Implements IViewMyCommunityStatistics.DisplaySessionTimeout
    ...
    Private Sub NoPermissionToAccess() Implements IViewMyCommunityStatistics.NoPermissionToAccess
        Me.BindNoPermessi()
    End Sub
    Public Sub DisplayUnknownUser() Implements IViewMyCommunityStatistics.DisplayUnknownUser
            ...
            If Not IsNothing(oTab) Then
                ...
                Select Case v
                    Case StatisticView.MyCommunity
                        oTab.NavigateUrl = BaseUrl & RootObject.MyCommunityStatistics(0, c.CommunityID, StatisticOrder.ModuleName, True, dView)
                    Case StatisticView.UsersCommunity
                        oTab.NavigateUrl = BaseUrl & RootObject.UsersCommunity(0, c.CommunityID, "", StatisticOrder.Owner, True, IIf(dView = StatisticView.MyCommunity, StatisticView.UsersCommunity, dView))
                    Case StatisticView.Community
                        oTab.NavigateUrl = BaseUrl & RootObject.CommunityStatistics(0, c.CommunityID, "", StatisticOrder.ModuleName, True, IIf(dView = StatisticView.MyCommunity, StatisticView.Community, dView))
                End Select
            End If
        Next
        Me.TBSusageTime.Visible = (views.Count > 1)
    End Sub
    Private Sub LoadItems(ByVal statistics As dtoStatistic, ByVal ucontext As UsageContext, ByVal vPage As StatisticView, ByVal detailType As DetailViewType) Implements IViewMyCommunityStatistics.LoadItems
    ...
    Public Sub LoadSummary(ByVal oSummary As dtoSummary, ByVal oType As IViewBaseStatistics.SummaryType) Implements IViewMyCommunityStatistics.LoadSummary
