...
Partial Public Class MySystemStatistics
    Inherits MSpageBase
    Implements IViewMySystemStatistics
...
#Region "Private Property"
    ...
    Private _Presenter As MySystemStatisticsPresenter
...
#Region "Base Context"
    Public Overloads ReadOnly Property BaseUrl() As String
        ...
        End Get
    End Property
    Public ReadOnly Property CurrentPresenter() As MySystemStatisticsPresenter
        Get
            If IsNothing(_Presenter) Then
                _Presenter = New MySystemStatisticsPresenter(PageUtility.CurrentContext, Me)
            End If
            Return _Presenter
        End Get
    End Property
...
#Region "View property"
    Public ReadOnly Property CurrentPageSize() As Integer Implements IViewMySystemStatistics.CurrentPageSize
        Get
            Return 25
        End Get
    End Property
    Public Property Pager() As lm.Comol.Core.DomainModel.PagerBase Implements IViewMySystemStatistics.Pager
        Get
        ...
        End Set
    End Property
    Public ReadOnly Property CurrentView() As StatisticView Implements IViewMySystemStatistics.CurrentView
        Get
            Return StatisticView.MySystem
        End Get
    End Property

    Public ReadOnly Property CurrentOrder() As StatisticOrder Implements IViewMySystemStatistics.CurrentOrder
        Get
        ...
        End Get
    End Property
    Public Property StatisticContext() As UsageContext Implements IViewMySystemStatistics.StatisticContext
        Get
...
#Region "Generici pagina"
    ...
    End Sub
#End Region
    Public Sub DisplaySessionTimeout() Implements IViewMySystemStatistics.DisplaySessionTimeout
    ...
    Private Sub NoPermissionToAccess() Implements IViewMySystemStatistics.NoPermissionToAccess
        Me.BindNoPermessi()
    End Sub
    ...
    End Sub
    Private Sub LoadItems(ByVal statistics As dtoStatistic, ByVal ucontext As UsageContext, ByVal vPage As StatisticView, ByVal detailType As DetailViewType) Implements IViewMySystemStatistics.LoadItems
        Me.GDVstatistic.DataSource = statistics.Items
        Me.GDVstatistic.DataBind()
        Me.PGgrid.BaseNavigateUrl = BaseUrl & RootObject.MySystemStatistics(ucontext.Order, ucontext.Ascending)
    End Sub
    ...
    Public Sub LoadSummary(ByVal oSummary As dtoSummary, ByVal oType As IViewBaseStatistics.SummaryType) Implements IViewMySystemStatistics.LoadSummary
                    ...
                    If TypeOf (oControl) Is System.Web.UI.WebControls.LinkButton Then
                        ...
                        If GetOrderByString(oLinkbutton.CommandArgument) = Me.CurrentOrder Then
                            If Me.Ascending Then
                                oHYPdesc.NavigateUrl = BaseUrl & RootObject.MySystemStatistics(Me.CurrentPage, GetOrderByString(oLinkbutton.CommandArgument), False)
                                oCell.Controls.Add(oHYPdesc)
                            Else
                                oHYPasc.NavigateUrl = BaseUrl & RootObject.MySystemStatistics(Me.CurrentPage, GetOrderByString(oLinkbutton.CommandArgument), True)
    ...
    Private Sub GDVstatistic_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GDVstatistic.RowDataBound
        If e.Row.RowType = ListItemType.Item Or e.Row.RowType = ListItemType.AlternatingItem Then
            ...
            If Not IsNothing(oHYPdetails) Then
                ...
                oHYPdetails.Visible = Not String.IsNullOrEmpty(oItem.NavigateTo) AndAlso Not IsNothing(oItem.Permission) AndAlso (oItem.Permission.ListSelfStatistic OrElse oItem.Permission.Administration)
            End If
