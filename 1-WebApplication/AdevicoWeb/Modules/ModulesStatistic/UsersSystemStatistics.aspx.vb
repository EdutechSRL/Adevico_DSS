...
Partial Public Class UsersSystemStatistics
    Inherits MSpageBase
    Implements IViewUsersSystemStatistics


#Region "Private Property"
    Private _PageUtility As OLDpageUtility
    Private _Presenter As UsersSystemStatisticsPresenter
...
#Region "Base Context"
    Public Overloads ReadOnly Property BaseUrl() As String
        ...
        End Get
    End Property
    Public ReadOnly Property CurrentPresenter() As UsersSystemStatisticsPresenter
        Get
            If IsNothing(_Presenter) Then
                _Presenter = New UsersSystemStatisticsPresenter(PageUtility.CurrentContext, Me)
            End If
            Return _Presenter
        End Get
    End Property
...
#Region "View property"
    Private ReadOnly Property CurrentPageSize() As Integer Implements IViewUsersSystemStatistics.CurrentPageSize
        Get
            Return 25
        End Get
    End Property

    Private Property Pager() As lm.Comol.Core.DomainModel.PagerBase Implements IViewUsersSystemStatistics.Pager
        Get
        ...
        End Set
    End Property
    Private ReadOnly Property CurrentView() As StatisticView Implements IViewUsersSystemStatistics.CurrentView
        Get
            Return StatisticView.UsersSystem
        End Get
    End Property

    Private ReadOnly Property CurrentOrder() As StatisticOrder Implements IViewUsersSystemStatistics.CurrentOrder
        Get
    ...
    Private ReadOnly Property PreloadedSearchBy() As String Implements IViewUsersSystemStatistics.PreloadedSearchBy
        Get
            Return Request.QueryString("SearchBy")
        End Get
    End Property
    Private Property StatisticContext() As UsageContext Implements IViewUsersSystemStatistics.StatisticContext
        Get
        ...
        End Set
    End Property
    Private Property CurrentSearchBy As String Implements IViewUsersSystemStatistics.CurrentSearchBy
        Get
...
#Region "Generici pagina"
    ...
    End Sub
#End Region
    Public Sub DisplaySessionTimeout() Implements IViewUsersSystemStatistics.DisplaySessionTimeout
    ...
    Private Sub NoPermissionToAccess() Implements IViewUsersSystemStatistics.NoPermissionToAccess
        Me.BindNoPermessi()
    End Sub
            ...
            If Not IsNothing(oTab) Then
                ...
                Select Case v
                    ...
                    Case StatisticView.System
                        oTab.NavigateUrl = BaseUrl & RootObject.SystemStatistics()
                End Select
            End If
        Next
        Me.TBSusageTime.Visible = (views.Count > 1)
    End Sub
    Private Sub LoadItems(ByVal statistics As dtoStatistic, ByVal ucontext As UsageContext, ByVal vPage As StatisticView, ByVal detailType As DetailViewType) Implements IViewUsersSystemStatistics.LoadItems
        Me.GDVstatistic.DataSource = statistics.Items
        Me.GDVstatistic.DataBind()
        Me.PGgrid.BaseNavigateUrl = BaseUrl & RootObject.UsersSystemStatistics(GetEncodedText(ucontext.SearchBy), ucontext.Order, ucontext.Ascending)
    End Sub
    ...
    Public Sub LoadSummary(ByVal oSummary As dtoSummary, ByVal oType As IViewBaseStatistics.SummaryType) Implements IViewUsersSystemStatistics.LoadSummary
...
#Region "Control"
                    ...
                    If TypeOf (oControl) Is System.Web.UI.WebControls.LinkButton Then
                        ...
                        If GetOrderByString(oLinkbutton.CommandArgument) = Me.CurrentOrder Then
                            If Me.Ascending Then
                                oHYPdesc.NavigateUrl = BaseUrl & RootObject.UsersSystemStatistics(Me.CurrentPage, GetEncodedText(tmpContext.SearchBy), GetOrderByString(oLinkbutton.CommandArgument), False)
                                oCell.Controls.Add(oHYPdesc)
                            Else
                                oHYPasc.NavigateUrl = BaseUrl & RootObject.UsersSystemStatistics(Me.CurrentPage, GetEncodedText(tmpContext.SearchBy), GetOrderByString(oLinkbutton.CommandArgument), True)
    ...
    Private Sub BTNsearch_Click(sender As Object, e As System.EventArgs) Handles BTNsearchByUserName.Click
        PageUtility.RedirectToUrl(RootObject.UsersSystemStatistics(0, Server.UrlEncode(CurrentSearchBy), StatisticOrder.UsageTime, False))
    End Sub
#End Region
