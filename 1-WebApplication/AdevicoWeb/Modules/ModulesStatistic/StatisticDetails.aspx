<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="StatisticDetails.aspx.vb" Inherits="Comunita_OnLine.StatisticDetails" %>
        ...
        <asp:View ID="VIWdata" runat="server">
            <div style="width: 900px; text-align: center; margin: 0,auto; padding-top: 5px; clear: both;"
                ...
                <telerik:RadTabStrip ID="TBSusageTime" runat="server" Align="Justify" Width="100%"
                    ...
                    <Tabs>
                        <telerik:RadTab Text="Giornaliero" Value="Day" Selected="true">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Settimanale" Value="Week">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Mensile" Value="Month">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Anno" Value="Year" Visible="false">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
            </div>
                ...
                <asp:View ID="VIWWeek" runat="server">
                    <div class="TimePicker">
                        ...
                        <telerik:RadDatePicker ID="RDTweek" runat="server" AutoPostBack="True">
                            <DateInput AutoPostBack="True" runat="server"></DateInput>
            ...
            <asp:Repeater ID="RPTstatistics" runat="server">
                <HeaderTemplate>
                    ...
                    <table class="table light" width="900px" cellpadding="0" cellspacing="0" rules="all">
