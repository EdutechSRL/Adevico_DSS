<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="CommunityStatistics.aspx.vb" Inherits="Comunita_OnLine.CommunityStatistics" Theme="Materiale" EnableTheming="true"%>
	   ...
	   <telerik:RadTabStrip ID="TBSusageTime" runat="server" Align="Justify" Width="100%" Height="20px"
	    CausesValidation="False" AutoPostBack="True"  Skin="Outlook" SelectedIndex="2">
		  <Tabs>
			 ...
			 <telerik:RadTab Text="Comunita'" Value="Community" Selected="true" Visible="false"></telerik:RadTab>
		  </Tabs>
	   </telerik:RadTabStrip>
    </div>			 
