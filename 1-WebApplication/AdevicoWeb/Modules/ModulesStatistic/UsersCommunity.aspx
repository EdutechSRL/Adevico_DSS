<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="UsersCommunity.aspx.vb" Inherits="Comunita_OnLine.UsersCommunityStatistics" Theme="Materiale" EnableTheming="true"%>
...
<asp:Content ID="Content6" ContentPlaceHolderID="CPHservice" runat="server">
    ...
    <div style="width: 900px; text-align:center; margin:0,auto; padding-top:5px; padding-left:5px; clear:both;" align="center">
	   <telerik:RadTabStrip ID="TBSusageTime" runat="server" Align="Justify" Width="100%" Height="20px"
	    CausesValidation="False" AutoPostBack="True"  Skin="Outlook" SelectedIndex="2">
		  <Tabs>
			 <telerik:RadTab Text="Personali" Value="MyCommunity" Visible="false"></telerik:RadTab>
			 <telerik:RadTab Text="Altri utenti" Value="UsersCommunity" Selected="true" Visible="false"></telerik:RadTab>
			 <telerik:RadTab Text="Generic Portal" Value="Community" Visible="false"></telerik:RadTab>
		  </Tabs>
	   </telerik:RadTabStrip>
    </div>	
    
    <div id="DVuserFilter" style="width:900px; text-align:left; padding-top:10px; padding-bottom:5px; margin: 0px auto;  clear:both;" runat="server">
        <asp:Label ID="LBsearcyByUsername_t" runat="server" AssociatedControlID="TXBsearch"></asp:Label>
        <asp:TextBox ID="TXBsearch" runat="server" Columns="50" MaxLength="60" SkinId="Filter"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="BTNsearchByUserName" runat="server" UseSubmitBehavior="true"/>
    </div>
    ...
    <div id="Div1" style="width:900px; text-align:center; padding-top:5px; margin: 0px auto;  clear:both;" runat="server">
		<asp:GridView cssclass="table light" Width="900px" runat="server" ID="GDVstatistic" AutoGenerateColumns="false" AllowSorting="true" UseAccessibleHeader="true">
		  <Columns>
			 <asp:TemplateField HeaderText="Owner" SortExpression="Owner" ItemStyle-HorizontalAlign="left">
				<ItemTemplate>
