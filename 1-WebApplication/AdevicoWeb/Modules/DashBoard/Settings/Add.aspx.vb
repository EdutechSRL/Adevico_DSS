...
Public Class AddDashboardSettings
...
#Region "Inherits"
    Public Overrides Sub BindDati()
        ...
        CurrentPresenter.InitView(True, PreloadIdDashboard, PreloadDashboardType, PreloadIdCommunity)
    End Sub
    ...
    Public Overrides Sub SetInternazionalizzazione()
        With Resource
            Master.ServiceTitle = .getValue("DashboardSettings.ServiceTitle.AddSettings")
            Master.ServiceNopermission = Resource.getValue("DashboardSettings.ServiceTitle.AddSettings.NoPermission")
            .setHyperLink(HYPbackToDashboardListBottom, False, True)
            .setHyperLink(HYPbackToDashboardListTop, False, True)
            .setButton(BTNaddDashboardSettingsBottom, True)
            .setButton(BTNaddDashboardSettingsTop, True)
        End With
    End Sub
    Protected Friend Overrides Sub DisplaySessionTimeout()
        RedirectOnSessionTimeOut(lm.Comol.Core.Dashboard.Domain.RootObject.DashboardList(PreloadDashboardType, False, IdContainerCommunity), IdContainerCommunity)
    End Sub
    ...
    Protected Friend Overrides Function GetSaveButton(Optional top As Boolean = True) As Button
        Return IIf(top, BTNaddDashboardSettingsTop, BTNaddDashboardSettingsBottom)
    End Function
...
#Region "internal"
    ...
    End Function
    Private Sub BTNaddDashboardSettingsTop_Click(sender As Object, e As EventArgs) Handles BTNaddDashboardSettingsTop.Click, BTNaddDashboardSettingsBottom.Click
