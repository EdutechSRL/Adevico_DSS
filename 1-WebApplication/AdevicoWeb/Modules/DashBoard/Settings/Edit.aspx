<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AjaxPortal.Master" CodeBehind="Edit.aspx.vb" Inherits="Comunita_OnLine.EditBaseDashboardSettings" %>
            ...
            <div class="rightcontent">
                <div class="header">
                    <div class="DivEpButton">
                         <asp:Button ID="BTNsaveDashboardSettingsTop" runat="server" class="linkMenu" Text="*Save" Visible="false" />
				...
				<div class="footer">
					<div class="DivEpButton">
                        <asp:Button ID="BTNsaveDashboardSettingsBottom" runat="server" class="linkMenu" Text="*Save" Visible="false" />
