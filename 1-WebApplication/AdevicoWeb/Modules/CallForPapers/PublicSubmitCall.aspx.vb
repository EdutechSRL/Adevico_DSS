...
#Region "Implements"
    ...
    Private Sub SetContainerName(name As String, itemName As String) Implements IViewBaseSubmission.SetContainerName
        ...
        Else
            title = String.Format(translation, IIf(Len(itemName) > 80, Left(itemName, 80) & "...", itemName))
        End If
...
#Region "Repeater binding"
    ...
    Private Sub RPTrequiredFiles_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTrequiredFiles.ItemDataBound
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim oControl As UC_InputRequiredFile = e.Item.FindControl("CTRLrequiredFile")
            oControl.InitializeControl(IdCall, 0, CallRepository, dto, Not AllowSave, True)
...
#End Region
    ...
    Private Sub BTNsubmitSubmissionBottom_Click(sender As Object, e As System.EventArgs) Handles BTNsubmitSubmissionBottom.Click, BTNsubmitSubmissionTop.Click
    ...
    Private Sub PublicCall_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
