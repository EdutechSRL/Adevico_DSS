...
#Region "Grid"
    Private Sub RPTevaluations_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles RPTevaluations.ItemDataBound
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Select Case CurrentEvaluationType
                ...
                Case EvaluationType.Dss
                    ...
                    SetDssValue(_AllEvaluated OrElse (dto.DssEvaluation.IsValid AndAlso dto.DssEvaluation.IsCompleted), dto.DssEvaluation, CallUseFuzzy, oLabel, e.Item.FindControl("SPNfuzzy"), e.Item.FindControl("CTRLfuzzyNumber"))
                    'Else
            ...
            oHyperlink.NavigateUrl = BaseUrl & RootObject.ViewSubmissionEvaluations(dto.IdSubmission, IdCall, IdCallCommunity, Me.IdCallAdvCommission)

            oHyperlink = e.Item.FindControl("HYPviewTableSubmissionEvaluation")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.ViewSubmissionTableEvaluations(dto.IdSubmission, IdCall, IdCallCommunity)
        ...
        ElseIf e.Item.ItemType = ListItemType.Header Then
            ...
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByUser, True, 0, PageSize, searchBy)
            oHyperlink = e.Item.FindControl("HYPorderByUserDown")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByUser, False, 0, PageSize, searchBy)

            oHyperlink = e.Item.FindControl("HYPorderByTypeUp")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByType, True, 0, PageSize, searchBy)
            oHyperlink = e.Item.FindControl("HYPorderByTypeDown")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByType, False, 0, PageSize, searchBy)

            oHyperlink = e.Item.FindControl("HYPorderByEvaluationPointsUp")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationPoints, True, 0, PageSize, searchBy)
            oHyperlink = e.Item.FindControl("HYPorderByEvaluationPointsDown")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationPoints, False, 0, PageSize, searchBy)


            oHyperlink = e.Item.FindControl("HYPorderByEvaluationIndexUp")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationIndex, True, 0, PageSize, searchBy)
            oHyperlink = e.Item.FindControl("HYPorderByEvaluationIndexDown")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationIndex, False, 0, PageSize, searchBy)

            oHyperlink = e.Item.FindControl("HYPorderByEvaluationStatusUp")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationStatus, True, 0, PageSize, searchBy)
            oHyperlink = e.Item.FindControl("HYPorderByEvaluationStatusUp")
            Resource.setHyperLink(oHyperlink, False, True)
            oHyperlink.NavigateUrl = BaseUrl & RootObject.EvaluationsSummary(IdCall, IdCallCommunity, PreloadView, 0, CurrentIdSubmitterType, CurrentFilterBy, SubmissionsOrder.ByEvaluationStatus, False, 0, PageSize, searchBy)
        End If
    End Sub
...
#End Region
    ...
    Public Sub SetStepSummaryLink(StepId As Long, CommId As Long, visible As Boolean) Implements IViewEvaluationsSummary.SetStepSummaryLink
