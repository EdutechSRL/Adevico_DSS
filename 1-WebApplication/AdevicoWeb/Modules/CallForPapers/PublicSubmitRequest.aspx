<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ExternalService.Master" CodeBehind="PublicSubmitRequest.aspx.vb" Inherits="Comunita_OnLine.PublicSubmitRequest" %>
        ...
        <asp:View ID="VIWstartMessage" runat="server">
            <div class="view">
                <div class="DivEpButton">
                    <asp:HyperLink ID="HYPlistFirstPage" runat="server" Text="Lista bandi" CssClass="Link_Menu" Visible="false"></asp:HyperLink>
                </div>
