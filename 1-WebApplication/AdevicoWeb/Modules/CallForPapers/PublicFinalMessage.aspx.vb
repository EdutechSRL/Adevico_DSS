...
Public Class PublicFinalMessage
    Inherits PageBase
...
#Region "Implements"
    ...
    Private Sub DisplaySessionTimeout() Implements IViewFinalMessage.DisplaySessionTimeout
        DisplaySessionTimeout(RootObject.FinalMessage(CallForPaperType.CallForBids, PreloadIdCall, PreloadedIdSubmission, PreloadedIdRevision, PreloadedUniqueID, False, FromPublicList, PreloadView, PreloadIdOtherCommunity))
    End Sub
...
#End Region
    ...
    Private Sub PublicFinalMessage_PreRender(sender As Object, e As System.EventArgs) Handles Me.PreRender
