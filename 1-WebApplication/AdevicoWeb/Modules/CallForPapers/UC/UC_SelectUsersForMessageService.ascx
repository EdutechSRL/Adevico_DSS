<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_SelectUsersForMessageService.ascx.vb" Inherits="Comunita_OnLine.UC_SelectCallUsersForMessageService" %>
            ...
            <ItemTemplate>
                <tr class="<%#me.RowItemCss(Container.DataItem)%>">
                    ...
                    <td class="name">
                        ...
                        <asp:Label ID="LBmailAddress" runat="server" Visible="false" Text='<%#Container.DataItem.MailAddress %>' ToolTip='<%#Container.DataItem.MailAddress %>' CssClass="checklenght"></asp:Label>
                    </td>
