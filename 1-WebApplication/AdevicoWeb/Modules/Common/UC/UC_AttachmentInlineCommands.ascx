<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_AttachmentInlineCommands.ascx.vb" Inherits="Comunita_OnLine.UC_AttachmentInlineCommands" %>
...
<asp:MultiView id="MLVcommands" runat="server">
    ...
    --><asp:LinkButton ID="LNBuploadtomoduleitem" runat="server" CssClass="linkMenu ddbutton" Visible="false" CommandArgument="232" CommandName="uploadtomoduleitem">*Upload File</asp:LinkButton><!--
    --><asp:LinkButton ID="LNBuploadtomoduleitemandcommunity" runat="server" CssClass="linkMenu ddbutton" Visible="false" CommandArgument="233" CommandName="uploadtomoduleitemandcommunity">*Upload File & Add to Community</asp:LinkButton><!--
    --><asp:LinkButton ID="LNBlinkfromcommunity" runat="server" CssClass="linkMenu ddbutton" Visible="false" CommandArgument="234" CommandName="linkfromcommunity">*Select Community File</asp:LinkButton><!--
    --><asp:LinkButton ID="LNBaddurltomoduleitem" runat="server" CssClass="linkMenu ddbutton" Visible="false" CommandArgument="235" CommandName="addurltomoduleitem">*Add URL</asp:LinkButton><!--
    --><asp:LinkButton ID="LNBaddurltomoduleitemandcommunity" runat="server" CssClass="linkMenu ddbutton" Visible="false" CommandArgument="236" CommandName="addurltomoduleitemandcommunity">*Add URL & Add to Community</asp:LinkButton><!--
--></asp:View>
