<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_GenericWizardSteps.ascx.vb" Inherits="Comunita_OnLine.UC_GenericWizardSteps" %>
...
<asp:Repeater ID="RPTsteps" runat="server">
    ...
    <ItemTemplate>
        ...
        <li class="<%#Container.DataItem.Css %> <%#Container.DataItem.DisplayOrderDetail.ToString() %>">
