Public Class UC_AttachmentInlineCommands
...
#End Region
    ...
    Private Sub DisplayCommandControls(controls As System.Web.UI.ControlCollection, visible As Boolean)
        ...
        Next
    End Sub
    'Private Sub ReplaceCss(autopostback As Boolean, dAction As lm.Comol.Core.DomainModel.Repository.RepositoryAttachmentUploadActions)
    '    If autopostback Then
    '        Dim oLinkbutton As LinkButton = FindControl("LNB" & dAction.ToString)
    '        If Not IsNothing(oLinkbutton) Then
    '            If oLinkbutton.CssClass <> LTddbuttonActive.Text Then
    '                LNBuploadtomoduleitem.CssClass = LTddbutton.Text
    '                LNBuploadtomoduleitemandcommunity.CssClass = LTddbutton.Text
    '                LNBlinkfromcommunity.CssClass = LTddbutton.Text
    '                LNBaddurltomoduleitem.CssClass = LTddbutton.Text
    '                LNBaddurltomoduleitemandcommunity.CssClass = LTddbutton.Text
