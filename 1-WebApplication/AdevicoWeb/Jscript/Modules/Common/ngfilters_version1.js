angular.module('ngfilters', [])
  .controller('filtercontroller', ['$scope', '$http', '$location', function ($scope, $http, $location) {
      ...
      $scope.getFilters = function () {
          $http.post(filterasmx + "/GetFilters", { "transactionid": transactionid, "filtermodule": filtermodule, "filtermodulescope": filtermodulescope, "filteridLanguage": filteridLanguage, "search": searchToObject(), "requiredpermissions": requiredp, "unloadcommunitites": unloadcommunitites, "onlyfromOrganizations": onlyfromOrganizations, "availabilitystring": availabilitystring}).
