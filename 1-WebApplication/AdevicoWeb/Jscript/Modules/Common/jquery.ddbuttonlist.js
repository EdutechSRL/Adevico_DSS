(function ($) {
    $.fn.dropdownButtonList = function (options) {
        ...
        return this.each(function () {
            var $self = $(this);
            if ($self.is(".enabled") && $self.is(":not(.initialized)")) {
            ...
            if ($self.is(":not(.initialized)")) {
                ...
                $self.filter(".enabled").find("span.selector a.ddbutton").click(function () {
                    ...
                    $el.addClass("active");
                    $(this).parents(".listwrapper").children(".ddbutton").removeClass("activeselected");
                    $(this).addClass("activeselected");
                    return false;
                });
                $self.filter(".enabled").find("span.selector").click(function () {
